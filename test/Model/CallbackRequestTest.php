...
class CallbackRequestTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $data = array(
            'credentials' => new Model\CallbackCredentials(),
            'uri' => 'uri'
        );

        self::$subject = new Model\CallbackRequest($data);
    }
    /**
    ...
    {
        $this->assertEquals(get_class(new Model\CallbackCredentials()), get_class(self::$subject->getCredentials()));
    }
    ...
    {
        $this->assertEquals("uri", self::$subject->getUri());
    }
}
