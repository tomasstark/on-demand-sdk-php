...
/**
 * TrustedUserResponseTest Class Doc Comment
 *
 * @category    Class */
// * @description TrustedUserResponse
/**
 * @package     Oda\Client
 * @author      Swagger Codegen team
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class TrustedUserResponseTest extends \PHPUnit_Framework_TestCase
{
    ...
    public static function setUpBeforeClass()
    {
        ...
        self::$subject = new Model\TrustedUserResponse($data);
    }

    /**
     * Test "TrustedUserResponse"
     */
    public function testTrustedUserResponse()
    {
        $expectedJson = '{
            "id": "id",
    ...
    {
        $this->assertEquals("identity_id", self::$subject->getIdentityId());
    }
}
