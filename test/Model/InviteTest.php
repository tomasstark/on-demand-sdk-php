...
class InviteTest extends \PHPUnit_Framework_TestCase
{
    ...
    public static function setUpBeforeClass()
    {
        ...
        self::$subject = new Model\Invite($data);
    }
     ...
     */
    public function testPropertyLegacyInvite()
    {
        $this->assertEquals(true, self::$subject->getLegacyInvite());
    }
    ...
    {
        $this->assertEquals("method", self::$subject->getMethod());
    }
}
