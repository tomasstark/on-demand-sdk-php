...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://api-int.kennect.com/v1';
    ...
    {
        $report  = 'PHP SDK (Oda\Client) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    OpenAPI Spec Version: 2018-05-08T16:44:26.238-07:00' . PHP_EOL;
