...
class DefaultApi
{
     ...
     */
    public function screeningsIdDocumentsAttachmentIdGet($id, $attachment_id)
    {
        list($response) = $this->screeningsIdDocumentsAttachmentIdGetWithHttpInfo($id, $attachment_id);
        return $response;
    }
     ...
     */
    public function screeningsIdDocumentsAttachmentIdGetWithHttpInfo($id, $attachment_id)
    {
        // verify the required parameter 'id' is set
        if ($id === null) {
