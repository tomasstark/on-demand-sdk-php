 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class Invite implements ArrayAccess
{
    ...
    {
        $this->container['legacy_invite'] = isset($data['legacy_invite']) ? $data['legacy_invite'] : null;
     ...
     * @return bool
     */
    public function getLegacyInvite()
    {
        return $this->container['legacy_invite'];
    }

    /**
     * Sets legacy_invite
     * @param bool $legacy_invite
     * @return $this
     */
    public function setLegacyInvite($legacy_invite)
    {
        $this->container['legacy_invite'] = $legacy_invite;
