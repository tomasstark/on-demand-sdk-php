...
/**
 * CandidateAlias Class Doc Comment
 *
 * @category    Class
 * @description Alternate information the candidate may also be known by
 * @package     Oda\Client
 * @author      Swagger Codegen team
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class CandidateAlias implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CandidateAlias';
     ...
     * @param bool $confirmed_no_middle_name Set to 'True' if the Candidate has no alternate middle name
     * @return $this
     */
    ...
    /**
     * Sets family_name
     * @param string $family_name The Candidate's alternate last name
     * @return $this
     */
    ...
    /**
     * Sets given_name
     * @param string $given_name The Candidate's alternate first name
     * @return $this
     */
    ...
    /**
     * Sets middle_name
     * @param string $middle_name The Candidate's alternate middle name
     * @return $this
     */
