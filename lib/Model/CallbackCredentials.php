...
/**
 * CallbackCredentials Class Doc Comment
 *
 * @category    Class
 * @package     Oda\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class CallbackCredentials implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CallbackCredentials';
    ...
    /**
     * Sets basic_auth
     * @param string $basic_auth Basic Auth credentials. In a 'username:password' format. (eg 'narf:zort!'
     * @return $this
     */
